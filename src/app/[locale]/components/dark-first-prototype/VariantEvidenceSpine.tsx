...
// The selected synthesis: A-inspired hero, C's timeline and content treatment, one violet accent.
    ...
    <div className="min-h-screen bg-[#0a0c10] font-sans text-[#edf0f7] selection:bg-[#8da2ff] selection:text-black">
      ...
      >
        <div className="flex flex-col justify-between border-b border-[#8da2ff]/15 p-6 sm:p-10 lg:border-r lg:border-b-0 lg:p-14">
          <div>
            <div className="flex items-center gap-2 font-mono text-[10px] tracking-[0.18em] text-[#8da2ff] uppercase">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-1">
          {content.credibility.map((item, index) => (
            ...
            >
              ...
              <div>
                <span className="font-mono text-3xl tracking-[-0.07em] text-[#8da2ff]">
                  {item.value}
                </span>
      ...
      <main className="mx-auto max-w-[1440px] border-x border-[#8da2ff]/15">
        <section
          id="spine-experience"
          className="border-b border-[#8da2ff]/15 px-5 py-20 sm:px-8 lg:px-14 lg:py-28"
        >
          <div className="mb-10 flex items-end justify-between">
            <div>
              <p className="font-mono text-[10px] tracking-[0.18em] text-[#8da2ff] uppercase">
                01 / Leadership experience
              </p>
              ...
              >
                ...
                <div>
                  <div className="flex flex-wrap items-start justify-between gap-2">
                    ...
                    {index < 2 && (
                      <span className="rounded-full border border-[#8da2ff]/20 bg-[#8da2ff]/5 px-2 py-1 font-mono text-[9px] tracking-wider text-[#8da2ff] uppercase">
                        Leadership signal
                      </span>
                    )}
                  </div>
              ...
              <div className="relative flex min-h-[420px] flex-col justify-between overflow-hidden border-b border-[#8da2ff]/15 bg-[#111724] p-7 xl:border-r xl:border-b-0">
                ...
                <div className="relative">
                  <div className="mb-4 flex items-center gap-2">
                    <span className="size-2 rounded-full bg-[#8da2ff]" />
                    <span className="font-mono text-[10px] tracking-widest text-[#8da2ff] uppercase">
                      Shipped product
                    </span>
                  </div>
                  ...
                  <p className="mt-5 max-w-md text-sm leading-6 text-white/45">
                    ...
                    discovery useful across language and preference boundaries.
                  </p>
                </div>
              </div>
              <div className="p-6 sm:p-8">
                <div className="grid gap-3 sm:grid-cols-3">
                  {content.outcomes.map((outcome) => (
                    ...
                    >
                      <Check className="size-4 text-[#8da2ff]" />
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-xs leading-5 text-white/45">
                        The live catalog was empty during the hydrated baseline,
                        so product-detail evidence remains unavailable.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <div className="mt-5 border-t border-white/10 pt-4">
                    <p className="text-xs text-[#8da2ff]/75">
                      {project.evidence}
                    </p>
        ...
        >
          ...
          <div className="mt-9 flex flex-wrap gap-3">
            <a
              ...
              className="flex items-center gap-2 rounded-md bg-[#8da2ff] px-5 py-3 text-xs font-semibold text-[#0a0c10]"
            >
